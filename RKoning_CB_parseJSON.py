...
def initTable_Tech() -> pandas.DataFrame:
    initTable = pandas.DataFrame({
        ...
        'DetectedFirst_date': pandas.to_datetime(numpy.empty(1, dtype=str)),
        'DetectedLast_date': pandas.to_datetime(numpy.empty(1, dtype=str))
    })
    # initTable['DetectedFirst'] = None
    # initTable['DetectedLast'] = None
    # initTable['DetectedFirst_date'] = None
    # initTable['DetectedLast_date'] = None
    # initTable['DetectedFirst_date'] = pandas.to_datetime(initTable['DetectedFirst_date'])
    # initTable['DetectedLast_date'] = pandas.to_datetime(initTable['DetectedLast_date'])
    return initTable
...
def initTable_Visit() -> pandas.DataFrame:
    ...
    initTable['visit_date'] = pandas.to_datetime(initTable['visit_date'])
    return initTable
...
def main():
    ...
    if I_flag:
        ...
        # Ready to add BuiltWith data
        #   Prepare CB Org data columns
        datOrg['id_lookup'] = numpy.nan
        datOrg['name_bw'] = numpy.nan
        datOrg['domain_bw'] = numpy.nan
        datOrg['vertical'] = numpy.nan
        datOrg['ARank'] = numpy.nan
        datOrg['QRank'] = numpy.nan
        datOrg['IndexFirst'] = numpy.nan
        datOrg['IndexLast'] = numpy.nan
        datOrg['IndexFirst_date'] = numpy.nan
        datOrg['IndexLast_date'] = numpy.nan

        datOrg['IndexFirst_date'] = pandas.to_datetime(datOrg['IndexFirst_date'])
        datOrg['IndexLast_date'] = pandas.to_datetime(datOrg['IndexLast_date'])

        datOrg['domain_sw'] = numpy.nan
        datOrg['filename_bw'] = numpy.nan
        datOrg['filename_sw'] = numpy.nan
        datOrg['I_response_bw'] = numpy.nan
        datOrg['I_response_sw'] = numpy.nan
